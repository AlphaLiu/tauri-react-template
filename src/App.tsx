...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-purple-50 to-blue-50 overflow-hidden">
      <AppTitleBar />
      <ScrollArea className="flex-1 overflow-hidden h-[calc(100vh-4rem)]">
        <main className="flex-1 flex flex-col items-center justify-center p-4 h-[calc(100vh-4rem)]">
