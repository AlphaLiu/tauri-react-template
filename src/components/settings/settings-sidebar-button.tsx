  ...
  return (
    <div className="relative">
      <button
        ...
        onClick={handleClick}
        className={`
          group animate-slide-in-left-fast flex w-full items-center gap-2.5 rounded-md px-3 py-2.5 text-sm font-medium
          focus:outline-none
          active:scale-[0.98]
          ${
    isActive
      ...
      {particles.map(particle => (
        <div
          key={particle.id}
          className="pointer-events-none absolute top-1/2 left-6 size-1.5 rounded-full bg-primary/70"
          style={
            {
