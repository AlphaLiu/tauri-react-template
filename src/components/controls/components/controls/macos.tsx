...
export function MacOS({ className, ...props }: HTMLProps<HTMLDivElement>) {
  ...
  return (
    <div className={cn('space-x-2 px-3 text-black active:text-black dark:text-black', className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
      <Button
        onClick={closeWindow}
