...
export function WindowTitlebar({ children, controlsOrder = 'system', className, windowControlsProps, ...props }: WindowTitlebarProps) {
  ...
  return (
    <div className={cn('bg-background flex select-none flex-row overflow-hidden', className)} data-tauri-drag-region {...props}>
      {left ? (
        <>
